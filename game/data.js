...
export const eventPool = [
    ...
    new LifeEvent({
        ...
        minAge: 6,
        maxAge: 14,
        criteria: (p) => (p.looks + p.respect)/2 < 75,
        effect: (p) => {
            p.happiness -= 5;
...
export const infoBoxPanels = {
    family: () => {
        for (let entry in state.your.family) {
            ...
            let relation = state.your.family[entry]["relation"];
